    ...
    <div className="bg-[#1a1a1a] border border-[#2a2a2a] rounded-lg p-6 relative">
      <svg viewBox="0 0 2560 1200" className="w-full h-auto">
        ...
        <g transform="translate(1075, 590)">
          ...
          <text x="0" y="13" fill="#bbb" fontSize="17" textAnchor="middle" fontWeight="600">{tBed}°C</text>
        </g>
        ...
        <g transform="translate(1390, 835)">
          ...
          <text x="0" y="13" fill="#bbb" fontSize="17" textAnchor="middle" fontWeight="600">{tOutlet}°C</text>
        </g>
        ...
        <g transform="translate(1460, 660)">
          ...
          <text x="0" y="13" fill="#bbb" fontSize="17" textAnchor="middle" fontWeight="600">{tQuench}°C</text>
        </g>
        ...
        <g transform="translate(2080, 614)">
          ...
          <text x="0" y="13" fill="#bbb" fontSize="17" textAnchor="middle" fontWeight="600">{tCoolerOutlet}°C</text>
        </g>
