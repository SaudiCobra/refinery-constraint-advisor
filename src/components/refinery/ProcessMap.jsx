      ...
      <svg viewBox="0 0 2560 1200" className="w-full h-auto">
        ...
        */}
        {(() => {
          ...
          const cx = ANCHORS.R1.x - SIZES.R1.w/2 - 18 - 52 - 18 - 14 - 12 - 12 - 18 - 18 - 36 - 36; // 946 (shifted left 36px more)
          const cy = ANCHORS.R1.y - 10 - 8 - 8 - 8 - 10 - 10 - 20 - 20;                            // 566 (shifted up 20px more)
          return (
