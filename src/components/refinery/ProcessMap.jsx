...
export default function ProcessMap({
  ...
  return (
    ...
    >
      ...
      <svg viewBox="0 0 2560 1200" className="w-full h-auto" style={{ transition: themeTransition }} onClick={e => e.stopPropagation()}>
        <defs>
        ...
        <g transform={`translate(${VALVES.TCV01B.x}, ${VALVES.TCV01B.y})`} onClick={(e) => handleUnitClick(e, 'tcv01b')} className={cn(interactive && "cursor-pointer")}>
          <g transform="translate(-38,-43.32) scale(0.76)" fill="none" stroke="#5A7A6F" strokeWidth="4" strokeLinejoin="round" strokeMiterlimit="10">
            <path d="M50 32 V56"/>
          ...
          {interactive && <text x="0" y="-46" fill={labelText} fontSize="16" textAnchor="middle" fontWeight="600">TCV-01B</text>}
        </g>
        ...
        <g transform={`translate(${ANCHORS.E1.x}, ${ANCHORS.E1.y})`} onClick={(e) => handleUnitClick(e, 'e1')} className={cn(interactive && "cursor-pointer hover:opacity-90 transition-all duration-400")} opacity={getNonAffectedOpacity("exchanger")}>
          {(() => {
            ...
            return (
              <>
                <ellipse cx={-SIZES.E1.w/2} cy="0" rx="10" ry={SIZES.E1.h/2 - 8} fill={equipFill2} stroke={stroke.color} strokeWidth="2.5" className="transition-all duration-700" />
                <rect x={-SIZES.E1.w/2} y={-SIZES.E1.h/2 + 8} width={SIZES.E1.w} height={SIZES.E1.h - 16} fill={equipFill} stroke={stroke.color} strokeWidth={stroke.width} filter="url(#equipmentShadow)" className="transition-all duration-700" />
                <ellipse cx={SIZES.E1.w/2} cy="0" rx="10" ry={SIZES.E1.h/2 - 8} fill={equipFill} stroke={stroke.color} strokeWidth="2.5" className="transition-all duration-700" />
              </>
            );
          })()}
          
          {[-50, -35, -20, -5, 10, 25, 40, 55].map(yOffset => (
            <line key={yOffset} x1={-SIZES.E1.w/2 + 12} y1={yOffset} x2={SIZES.E1.w/2 - 12} y2={yOffset} stroke={hatchLine} strokeWidth="1.5" opacity="0.9" />
          ))}
        ...
        <g opacity={valveStates.tcv01a === "OOS" ? 0.3 : 1}>
          ...
          <g transform={`translate(${VALVES.TCV01A.x}, ${VALVES.TCV01A.y})`} onClick={(e) => handleUnitClick(e, 'tcv01a')} className={cn(interactive && "cursor-pointer")}>
            <g transform="translate(-31,-35.34) scale(0.62)" fill="none" stroke={valveStates.tcv01a === "OPEN" ? "#2F5D80" : valveStates.tcv01a === "OOS" ? "#A13A1F" : "#555"} strokeWidth="4" strokeLinejoin="round" strokeMiterlimit="10">
              <path d="M50 32 V56"/>
              <path d="M37.648 31.852 C40.395 26.16 45.029 22.728 50 22.728 C54.971 22.728 59.605 26.16 62.352 31.852 Z"/>
              <path d="M25 42 L50 57 L25 72 Z"/>
              <path d="M75 42 L50 57 L75 72 Z"/>
            ...
            {interactive && (
              <>
                <text x="0" y="-20" fill={labelText} fontSize="16" textAnchor="middle" fontWeight="600">TCV-01A</text>
                <text x="0" y="32" fill={subText} fontSize="14" textAnchor="middle">Tube Bypass</text>
              </>
            )}
          </g>
              ...
              <g key={bed.id}>
                ...
                {idx < bedImbalance.beds.length - 1 && (
                  <g>
                    ...
                    {/* Quench Control Valve — centered on the pipe dot, left of Q label; tied to H2 availability */}
                    <g transform={`translate(${SIZES.R1.w/2 + 20}, ${yStart + bedHeight + 3})`}>
                      <g transform="translate(-27.5,-31.35) scale(0.55)" fill="none" stroke={equipment.h2Compressor ? "#4A90E2" : "#555"} strokeWidth="4" strokeLinejoin="round" strokeMiterlimit="10">
                        <path d="M50 32 V56"/>
                        <path d="M37.648 31.852 C40.395 26.16 45.029 22.728 50 22.728 C54.971 22.728 59.605 26.16 62.352 31.852 Z"/>
                        <path d="M25 42 L50 57 L25 72 Z"/>
                        <path d="M75 42 L50 57 L75 72 Z"/>
        ...
        <g>
          ...
          <g transform={`translate(${VALVES.TCV02A.x - 40}, ${VALVES.TCV02A.y})`} onClick={(e) => handleUnitClick(e, 'tcv02a')} className={cn(interactive && "cursor-pointer")}>
            <g transform="translate(-31,-35.34) scale(0.62)" fill="none" stroke={valveStates.tcv02a === "OPEN" ? "#5A7A6F" : "#B47A1F"} strokeWidth="4" strokeLinejoin="round" strokeMiterlimit="10">
              <path d="M50 32 V56"/>
              <path d="M37.648 31.852 C40.395 26.16 45.029 22.728 50 22.728 C54.971 22.728 59.605 26.16 62.352 31.852 Z"/>
              <path d="M25 42 L50 57 L25 72 Z"/>
              <path d="M75 42 L50 57 L75 72 Z"/>
            ...
            {interactive && (
              <>
                <text x="0" y="20" fill={labelText} fontSize="16" textAnchor="middle" fontWeight="600">TCV-02A</text>
                <text x="0" y="36" fill={subText} fontSize="14" textAnchor="middle">Shell Return</text>
              </>
            )}
          </g>
        ...
        <g opacity={valveStates.tcv02b === "CLOSED" ? 0.3 : 1}>
          ...
          <line x1={ANCHORS.R1.x} y1={Y_LOWER_ZONE - 20} x2={VALVES.TCV02B.x} y2={Y_LOWER_ZONE - 20} stroke={pipeStroke} strokeWidth="3" strokeDasharray="6,6" opacity="0.9" />
          ...
          <line x1={VALVES.TCV02B.x} y1={Y_LOWER_ZONE - 20} x2={VALVES.TCV02B.x} y2={Y_LOWER_ZONE + 85} stroke={pipeStroke} strokeWidth="3" strokeDasharray="6,6" opacity="0.9" />
          ...
          <line x1={VALVES.TCV02B.x} y1={Y_LOWER_ZONE + 85} x2={ANCHORS.E2.x - SIZES.E2.w/2 - 70} y2={Y_LOWER_ZONE + 85} stroke={pipeStroke} strokeWidth="3" strokeDasharray="6,6" opacity="0.9" />
          {valveStates.tcv02b !== "CLOSED" && (
        ...
        <line x1={ANCHORS.E1.x + SIZES.E1.w/2} y1={ANCHORS.E1.y + SIZES.E1.h/2 - 18} x2={ANCHORS.E1.x + SIZES.E1.w/2} y2={Y_UPPER_ZONE - 60} stroke={pipeStroke} strokeWidth="4" opacity="0.9" />
        {/* Horizontal run in upper corridor above reactor */}
        <line x1={ANCHORS.E1.x + SIZES.E1.w/2} y1={Y_UPPER_ZONE - 60} x2={ANCHORS.E2.x - SIZES.E2.w/2} y2={Y_UPPER_ZONE - 60} stroke={pipeStroke} strokeWidth="4" opacity="0.9" />
        {/* Vertical drop to E-2 inlet on spine */}
        <line x1={ANCHORS.E2.x - SIZES.E2.w/2} y1={Y_UPPER_ZONE - 60} x2={ANCHORS.E2.x - SIZES.E2.w/2} y2={Y_SPINE} stroke={pipeStroke} strokeWidth="4" opacity="0.9" />
        ...
        <g opacity={valveStates.tcv03a === "CLOSED" ? 0.3 : 1}>
          ...
          <g transform={`translate(${VALVES.TCV03A.x}, ${VALVES.TCV03A.y})`} onClick={(e) => handleUnitClick(e, 'tcv03a')} className={cn(interactive && "cursor-pointer")}>
            ...
            {interactive && (
              <>
                <text x="0" y="28" fill={labelText} fontSize="16" textAnchor="middle" fontWeight="600">TCV-03A</text>
                <text x="0" y="44" fill={subText} fontSize="14" textAnchor="middle">Cooler Bypass</text>
              </>
            )}
          </g>
        ...
        <g transform={`translate(${ANCHORS.D1.x}, ${ANCHORS.D1.y})`} onClick={(e) => handleUnitClick(e, 'd1')} className={cn(interactive && "cursor-pointer hover:opacity-90 transition-all duration-400")} opacity={getNonAffectedOpacity("separator")}>
          ...
          {interactive && <text x="0" y={-SIZES.D1.h/2 - 58} fill={subText} fontSize="16" textAnchor="middle">Gas</text>}
